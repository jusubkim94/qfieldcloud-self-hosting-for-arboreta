...
[![QFieldCloud 설치 파일 다운로드](https://img.shields.io/badge/QFieldCloud_%EC%84%A4%EC%B9%98_%ED%8C%8C%EC%9D%BC-v0.1.2_%EB%8B%A4%EC%9A%B4%EB%A1%9C%EB%93%9C-2ea44f?style=for-the-badge)](https://raw.githubusercontent.com/jusubkim94/qfieldcloud-self-hosting-for-arboreta/b8682771baf3e938f984690971deb4a0647d9b6b/releases/lab-lightsail/v0.1.2/qfieldcloud-lab-lightsail-v0.1.2.zip)
...
[![Windows GUI 편집기 다운로드](https://img.shields.io/badge/Windows_GUI_%ED%8E%B8%EC%A7%91%EA%B8%B0-v0.1.2_%EB%8B%A4%EC%9A%B4%EB%A1%9C%EB%93%9C-2563eb?style=for-the-badge&logo=windows)](https://raw.githubusercontent.com/jusubkim94/qfieldcloud-self-hosting-for-arboreta/b8682771baf3e938f984690971deb4a0647d9b6b/releases/tools/qfieldcloud-template-editor/v0.1.2/QFieldCloudTemplateEditor-v0.1.2.exe)
...
1. `QFieldCloudTemplateEditor-v0.1.2.exe`를 실행합니다.
...
앱은 AWS에 접속하거나 Access Key를 요구하지 않습니다. 코드 서명이 없어 Windows SmartScreen 경고가 나타날 수 있습니다. EXE SHA-256은 `69296db5eb8c990a58e1d518430a82be5a6ad20a0db39121762a8397a579be21`입니다.
...
- 다운로드용 ZIP: [`qfieldcloud-lab-lightsail-v0.1.2.zip`](releases/lab-lightsail/v0.1.2/qfieldcloud-lab-lightsail-v0.1.2.zip)
- ZIP 안의 배포 파일: [`template.yaml`](releases/lab-lightsail/v0.1.2/template.yaml)
- 릴리스 정보: [`manifest.json`](releases/lab-lightsail/v0.1.2/manifest.json)
- 무결성 값: [`SHA256SUMS`](releases/lab-lightsail/v0.1.2/SHA256SUMS)
- Template SHA-256: `f3c3391704bf07f7ab6b13d1b16115a105d50e4f07a52b4a5ff337bf2adabff4`
- 고정된 설치 소스: `00b34aff5370b64f1e5bfa3be09dbad8002b8426`
