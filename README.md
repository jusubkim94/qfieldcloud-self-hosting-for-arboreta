...
[![QFieldCloud 설치 파일 다운로드](https://img.shields.io/badge/QFieldCloud_%EC%84%A4%EC%B9%98_%ED%8C%8C%EC%9D%BC-v0.1.3_%EB%8B%A4%EC%9A%B4%EB%A1%9C%EB%93%9C-2ea44f?style=for-the-badge)](https://raw.githubusercontent.com/jusubkim94/qfieldcloud-self-hosting-for-arboreta/ad3db49aa4242225b6b3fcd40b8f74e86579c6dc/releases/lab-lightsail/v0.1.3/qfieldcloud-lab-lightsail-v0.1.3.zip)
...
[![Windows GUI 편집기 다운로드](https://img.shields.io/badge/Windows_GUI_%ED%8E%B8%EC%A7%91%EA%B8%B0-v0.1.3_%EB%8B%A4%EC%9A%B4%EB%A1%9C%EB%93%9C-2563eb?style=for-the-badge&logo=windows)](https://raw.githubusercontent.com/jusubkim94/qfieldcloud-self-hosting-for-arboreta/ad3db49aa4242225b6b3fcd40b8f74e86579c6dc/releases/tools/qfieldcloud-template-editor/v0.1.3/QFieldCloudTemplateEditor-v0.1.3.exe)
...
1. `QFieldCloudTemplateEditor-v0.1.3.exe`를 실행합니다.
...
앱은 AWS에 접속하거나 Access Key를 요구하지 않습니다. 코드 서명이 없어 Windows SmartScreen 경고가 나타날 수 있습니다. EXE SHA-256은 `e891e7446a8eedae9ce85724e6d6ce0549dd9ecb19b0a267ece26a9e23972690`입니다.
...
- 다운로드용 ZIP: [`qfieldcloud-lab-lightsail-v0.1.3.zip`](releases/lab-lightsail/v0.1.3/qfieldcloud-lab-lightsail-v0.1.3.zip)
- ZIP 안의 배포 파일: [`template.yaml`](releases/lab-lightsail/v0.1.3/template.yaml)
- 릴리스 정보: [`manifest.json`](releases/lab-lightsail/v0.1.3/manifest.json)
- 무결성 값: [`SHA256SUMS`](releases/lab-lightsail/v0.1.3/SHA256SUMS)
- Template SHA-256: `c977828bf0828074643fb03fa5c3bba9b99c1313da9c5514333d485b233b7677`
- 고정된 설치 소스: `b9b9ecc0ec5263a0d7172164d31239653530cfa6`
...
- `v0.1.3`은 외부 80/443 보호 규칙을 약화하지 않고 Docker 내부에만 공개되는 worker API 포트를 사용하도록 수정했지만, 아직 실제 AWS 재시험 전입니다.
