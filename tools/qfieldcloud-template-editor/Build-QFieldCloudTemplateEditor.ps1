...
$templatePath = Join-Path $repositoryRoot 'releases/lab-lightsail/v0.1.0/template.yaml'
$compilerCandidates = @(
...
$outputPath = Join-Path $OutputDirectory 'QFieldCloudTemplateEditor-v0.1.0.exe'
$arguments = @(
    '/nologo'
    '/target:winexe'
    '/platform:anycpu'
