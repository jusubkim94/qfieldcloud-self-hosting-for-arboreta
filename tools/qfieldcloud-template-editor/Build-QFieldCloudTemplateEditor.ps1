...
$templatePath = Join-Path $repositoryRoot 'releases/lab-lightsail/v0.1.4/template.yaml'
$compilerCandidates = @(
...
$outputPath = Join-Path $OutputDirectory 'QFieldCloudTemplateEditor-v0.1.4.exe'
$arguments = @(
    '/nologo'
    '/target:winexe'
    '/platform:anycpu'
