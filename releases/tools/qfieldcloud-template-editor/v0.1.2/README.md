...
`QFieldCloudTemplateEditor-v0.1.2.exe`는 `lab-lightsail` v0.1.2 배포 YAML을 로컬에서 수정·검증·저장하는 Windows GUI 앱입니다.
...
- EXE SHA-256: `69296db5eb8c990a58e1d518430a82be5a6ad20a0db39121762a8397a579be21`
