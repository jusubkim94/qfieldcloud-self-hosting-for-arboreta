...
`QFieldCloudTemplateEditor-v0.1.1.exe`는 `lab-lightsail` v0.1.1 배포 YAML을 로컬에서 수정·검증·저장하는 Windows GUI 앱입니다.
...
- EXE SHA-256: `d4acbcb0fc5f096652f0795154b55853f8af800c8f690b093b100058121e01a8`
